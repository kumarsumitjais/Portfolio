    ...
    <div ref={ref} className="relative flex w-full">
      ...
      >
        {(() => {
            ...
            <div className="flex flex-col sm:flex-row h-full">
              ...
              <div className="p-6 flex flex-col justify-center flex-grow">
                ...
                <div className="flex items-center justify-between mt-auto pt-4 border-t border-border-card/50">
                  ...
                  {ach.blogUrl && (
                    <div className="text-sm font-medium text-text-primary group-hover:text-cyan-400 transition-colors flex items-center gap-2">
          ...
          const wrapperClass = "block w-full bg-bg-card border border-border-card rounded-2xl overflow-hidden shadow-level-1 group hover:border-cyan-400/50 hover:shadow-[0_0_15px_rgba(34,211,238,0.15)] transition-all duration-300 h-full";

          return ach.blogUrl ? (
            <Link href={ach.blogUrl} className={wrapperClass}>
              {content}
            </Link>
          ) : (
